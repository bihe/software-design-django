...
class TestProduct(TestCase):
    ...
    def test_get_products_in_price_range(self) -> None:
        Product.objects.create(name="testproduct1", price=11.99, description="testdescription1")
        ...
        Product.objects.create(name="testproduct4", price=30.00, description="testdescription4")
